export default function Funding(props) {
    return (
        <div className="w-full relative  flex flex-col bg-black">
            <a name="funding" />
            <div className="relative w-full z-40  flex lg:flex-row flex-col lg:items-center gap-10">

                <div className="xl:pl-52 lg:w-1/2 flex flex-col text-white gap-5 p-8 py-24">
                    <div>
                    ...
                    <p className="mt-5 font-bold text-2xl lg:text-3xl">Rising together through grants and investment.</p>
                    <p className="font-medium lg:text-lg">The Elevate Program features a $20 million funding pool for innovative projects building on Neo X. Various tracks are available to support different growth stages. Apply early to be among the first to launch.</p>
                    <div className="mt-8">
                ...
                <div className="lg:w-1/2 h-full relative ">
                    <img className="" src="/assets/elevate_banner.png" />
                </div>
            </div>

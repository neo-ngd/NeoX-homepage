    ...
    return (
        <main className="antialiased w-full  flex flex-col">
            ...
            <div className="w-full relative  flex flex-col py-24">
                ...
                <div className="max-w-6xl mx-auto w-full px-8 z-40 flex flex-col items-center">
                    <p className="lg:text-5xl text-3xl lg:text-center text-left font-bold mb-24">Elevate Goals</p>
            ...
            <div className="bg-[#D9D9D9]/10 py-24">
                ...
                <div className="max-w-6xl mx-auto w-full px-8 z-40 flex flex-col ">
                    <svg width="334" height="37" viewBox="0 0 334 37" fill="none" xmlns="http://www.w3.org/2000/svg">
